...
<Info>
  All CLI documentation matches the actual backend implementation. For detailed setup and usage, visit [https://superbox.1mindlabs.org/docs](https://acm-aa28ebf6.mintlify.app)
</Info>
...
# WebSocket API (for pull/test commands)
...
<Info>
  For complete documentation, visit [https://superbox.1mindlabs.org/docs](https://acm-aa28ebf6.mintlify.app)
</Info>
