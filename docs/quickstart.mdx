...
<Steps>
  <Step title="Browse Servers">
    Visit [SuperBox](https://superbox.1mindlabs.org/explore) to browse available MCP servers.
  </Step>
...
<Steps>
  ...
  <Step title="Execute MCP Server">
    Configure your AI client (VS Code, Cursor, Claude Desktop) using:
    
    ```bash
    superbox pull --name weather-server --client vscode
    ```
    
    The server will be available in your AI client's MCP tools list.
  </Step>
</Steps>
