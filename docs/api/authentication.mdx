...
<Steps>
  <Step title="Create an Account">
    Sign up at [SuperBox](https://superbox-ai.vercel.app) using one of our supported providers:
  ...
  <Step title="Navigate to Settings">
    Go to your [Profile Settings](https://superbox-ai.vercel.app/settings) page.
  </Step>
