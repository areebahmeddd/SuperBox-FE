...
<Tabs>
  ...
  <Tab title="Authenticated Endpoints">
    ...
    <Info>
      Authenticated endpoints have higher rate limits (1000 req/hour)
    </Info>
  </Tab>
</Tabs>
...
curl -X GET "https://api.superbox.dev/api/v1/user/profile" \
  -H "Authorization: Bearer $SUPERBOX_API_TOKEN"
...
<CardGroup cols={2}>
  <Card title="Create Your First Server" icon="rocket" href="/api/servers/create">
