...
<Steps>
 ...
 Sign up at [SuperBox](https://superbox.1mindlabs.org) using one of our supported providers:
...
<Card title="Email" icon="envelope">
 ...
 Go to your [Profile Settings](https://superbox.1mindlabs.org/settings) page.
  </Step>
...
Delete a server
 ...
 <Note>MCP execution happens via WebSocket API (not HTTP endpoints). Use `superbox pull` to configure AI clients.</Note>
...
curl -X GET "https://api.superbox.ai/api/v1/auth/me" \
  -H "Authorization: Bearer $SUPERBOX_API_TOKEN"
