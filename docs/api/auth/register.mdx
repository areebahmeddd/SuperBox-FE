...
api: "POST https://api.superbox.ai/v1/auth/register"
icon: "user-plus"
---
...
```javascript
JavaScript
const response = await fetch("https://api.superbox.ai/v1/auth/register", {
  method: "POST",
  headers: {
...
response = requests.post(
    'https://api.superbox.ai/v1/auth/register',
    json={
        'email': 'areeb@example.com',
        'username': 'areeb',
        'password': 'SecurePass123!',
