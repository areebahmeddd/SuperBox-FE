...
api: "GET https://api.superbox.ai/v1/auth/profile"
icon: "user"
---
...
```javascript
JavaScript
const response = await fetch("https://api.superbox.ai/v1/auth/profile", {
  headers: {
...
response = requests.get(
    'https://api.superbox.ai/v1/auth/profile',
...
response = requests.post(
    'https://api.superbox.ai/v1/auth/change-password',
    headers={'Authorization': f'Bearer {token}'},
    json={
        'current_password': 'OldPass123!',
        'new_password': 'NewSecurePass456!',
