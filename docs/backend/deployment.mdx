...
docker tag superbox-api:latest <account-id>.dkr.ecr.ap-south-1.amazonaws.com/superbox-api:latest
```

```bash
Push Image
docker push <account-id>.dkr.ecr.ap-south-1.amazonaws.com/superbox-api:latest
```
