...
<Check>**Clear Tool Names** - Use descriptive, action-oriented names (e.g., `get_weather`, `search_database`)</Check>
<Check>**Comprehensive Schemas** - Define all parameters with descriptions and constraints</Check>
...
<Check>**Logging** - Log all tool invocations for debugging and analytics</Check>
<Check>**Security** - Validate inputs, sanitize outputs, use authentication</Check>
<Check>**Documentation** - Provide clear descriptions for all tools and resources</Check>
...
<CardGroup cols={2}>
  ...
  <Card title="Database MCP" icon="database">
    Safe database querying interface
...
<Info>
  Full MCP specification: [modelcontextprotocol.io](https://modelcontextprotocol.io)
</Info>
